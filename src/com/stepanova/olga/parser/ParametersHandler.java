package com.stepanova.olga.parser;
...
public class ParametersHandler {
    ...
    public void add(DateParameters parameter, int value) {
    ...
    public String cronToPrint(String cron) {
    ...
    private int checkDistance(ArrayList<Integer> set) {
    ...
    public boolean checkCronExpression(String cron, List<Date> listOfDates) {
        if (cron.equals("* * * * * *")) {
            return false;
        }
        String[] strArray = cron.split(" ");
